...
<head>
  ...
  <meta property="og:locale" content="en_IND">
    ...
    <!-- favicon Icon -->
    <link rel="android-chrome-icon" sizes="512x512" href="../faviconIcons/apple-touch-icon.png">
    <link rel="android-chrome-icon" sizes="192x192" href="../faviconIcons/apple-touch-icon.png">
    <link rel="apple-touch-icon" sizes="180x180" href="../faviconIcons/apple-touch-icon.png">
    <link rel="icon" type="image/png" sizes="32x32" href="../faviconIcons/favicon-32x32.png">
    <link rel="icon" type="image/png" sizes="16x16" href="../faviconIcons/favicon-16x16.png">
    <!-- favicon Icon End -->

    <!-- Custom Css File  -->
    <link rel="stylesheet" href="../client/cssFile/style.css">
